...
import { FiMail, FiLock, FiEye, FiEyeOff, FiArrowRight, FiFileText } from 'react-icons/fi';
    ...
    <div className="min-h-screen bg-navy-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-bold font-display text-white">Access Your Workspace</h2>
          <p className="text-sm text-slate-400 font-light mt-1.5">Sign in to edit your resumes</p>
        </div>
        ...
        <div className="glass p-8 rounded-2xl border border-white/5 shadow-2xl relative">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-4 py-3 rounded-xl bg-navy-900/50 border border-slate-800 focus:border-indigo-500 focus:bg-navy-900/80 text-white text-sm placeholder-slate-500 outline-none transition-all"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 py-3 rounded-xl bg-navy-900/50 border border-slate-800 focus:border-indigo-500 focus:bg-navy-900/80 text-white text-sm placeholder-slate-500 outline-none transition-all"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-3 px-4 rounded-xl text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 shadow-lg shadow-indigo-500/20 disabled:opacity-50 transition-all flex items-center justify-center space-x-2 cursor-pointer"
            >
